...
public class TransactionController {
    ...
    @GetMapping("/monthly-comparison/{customerId}")
    public Map<String, Object> getMonthlyComparison(@PathVariable Long customerId) {
        return transactionService.getMonthlyComparison(customerId);
    }
}
